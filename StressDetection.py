...
# Note : it is  necessary to remove all null values to get most efficient results

# Now we clan the dataset by removing stopwords,links,special symbols ,language errors etc
nltk.download('stopwords') # In natural language processing, useless words (data), are referred to as stop words. 
